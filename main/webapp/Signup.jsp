...
<body>
	...
	<form action="SaveUser" enctype="multipart/form-data" method="post">
		...
		<input type="text" name="name" class="in" > <br> <br> <br>
		<label class="lb">Email:</label>
		<input type="email" name="email" class="in" > <br> <br> <br>
		<label class="lb">Contact:</label>
		<input type="number" name="contact" class="in" > <br> <br> <br>
		<label class="lb">Password :</label>
		<input type="password" name="pass" class="in"> <br> <br>
		<label class="lb">Image : </label>
		<input type="file" name="image" class="in"> <br> <br>
